...
module.exports = {
  ...
  async execute(interaction) {
    const description = [
      "**Lệnh cơ bản**",
      "⚽ **/epl** - Danh sách trận EPL đang mở (có mã trận)",
      "⚽ **/wc** - Danh sách trận World Cup 2026 đang mở (có mã trận)",
      "⚽ **/laliga** - Danh sách trận LaLiga đang mở (có mã trận)",
      "⚽ **/uefa** - Danh sách trận UEFA Champions League đang mở (có mã trận)",
      "⚽ **/asia** - Danh sách trận AFC Asian Cup + Saudi Pro League đang mở",
      "🏀 **/nba** - Danh sách trận NBA đang mở (có mã trận)",
      "⚡ **/bet-epl** - Đặt cược EPL bằng nút chọn",
      "⚡ **/bet-wc** - Đặt cược World Cup 2026 bằng nút chọn",
      "⚡ **/bet-laliga** - Đặt cược LaLiga bằng nút chọn",
      "⚡ **/bet-uefa** - Đặt cược UEFA Champions League bằng nút chọn",
      "⚡ **/bet-asia** - Đặt cược chung AFC Asian Cup + Saudi Pro League",
      "⚡ **/bet-nba** - Đặt cược NBA bằng nút chọn",
      "\ud83d\udcb0 **/balance** - Xem số dư điểm của bạn",
      "\ud83d\udcd3 **/bets** - Xem lịch sử đặt cược",
      "\ud83d\udd34 **/live-epl** - Xem trận EPL đang live",
      "\ud83d\udd34 **/live-laliga** - Xem trận LaLiga đang live",
      "\ud83d\udd34 **/live-uefa** - Xem trận UEFA Champions League đang live",
      "\ud83d\udd34 **/live-asia** - Xem trận AFC Asian Cup + Saudi Pro League đang live",
      ...
      "💠 **/nohuv2** - Nổ hũ 6x6 combo cụm + cascade",
